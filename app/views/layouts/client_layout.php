...
<head>
    ...
    <link href="<?php echo _WEB_ROOT; ?>/public/assets/clients/lib/owlcarousel/assets/owl.carousel.min.css"
        rel="stylesheet">
    ...
    <script>
        $(document).ready(function () {
            <?php if (isset($_SESSION['toastr'])): ?>
                toastr.<?php echo $_SESSION['toastr']['type']; ?>("<?php echo htmlspecialchars($_SESSION['toastr']['message']); ?>");
                <?php unset($_SESSION['toastr']); // Xóa sau khi hiển thị ?>
            <?php endif; ?>
        });
    </script>
</body>
